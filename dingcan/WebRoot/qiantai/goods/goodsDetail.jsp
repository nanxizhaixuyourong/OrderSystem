...
<div id="MainCenter" align="center" class="MainCenter">
		 ...
		 <div id="content" class="Sub">
				<div class="NewContainer770">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">菜品详情</div>
					</div>
					<div class="Slot">
					    <form action="<%=path %>/addToCart.action" method="post" name="buy">
						<table width="100%" border="0">
						    <tr>
						       <td align="center">品名：<s:property value="#request.goods.goodsName"/></td>
						    </tr>
						    <tr>
						       <td align="center"><hr/></td>
						    </tr>
						    <tr>
						       <td align="center">介绍：<s:property value="#request.goods.goodsMiaoshu" escape="false"/></td>
						    </tr>
						    <tr>
						       <td align="center"><hr/></td>
						    </tr>
						    <tr>
						       <td align="center">价格：<s:property value="#request.goods.goodsTejia"/></td>
						    </tr>
						    <tr>
						       <td align="center"><hr/></td>
						    </tr>
						    <tr>
						       <td align="center">预定数量：
						          <input type="text" name="quantity" value="1" size="8" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')"/>
						          <input type="hidden" name="goodsId" value="<s:property value="#request.goods.goodsId"/>"/>
						          <input type="button" value="预定" onclick="buy1()"/>
						       </td>
						    </tr>
						</table>
						</form>
