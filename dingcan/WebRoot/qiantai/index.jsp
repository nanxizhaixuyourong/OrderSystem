				...
				<div class="NewContainer770">
					<div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">
						     <span style="float:left">排行榜</span>
						...
						<table cellspacing="5" width="100%">
			                 ...
			                 <td align="center">
			                     <a href="<%=path %>/goodsDetail.action?goodsId=<s:property value="#goods.goodsId"/>">
								     <img width="140" height="110" src="<%=path %>/<s:property value="#goods.goodsPic"/>"/>
								 </a>
			                     <br/>
			                     <s:property value="#goods.goodsName"/>
			                     <br/>
			                        单价:<s:property value="#goods.goodsShichangjia"/>
			                  </td>
			                  </s:iterator>
					          </tr>
					   </table>
                    ...
                    <div class="BoxHeader">
						<div class="BoxHeader-center MarginTop10">
						     <span style="float:left">特价区</span>
